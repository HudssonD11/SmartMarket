...
public class EstabelecimentoService 
{
    ...
    public void makeForm()
    {
		...
		form += "</li>";
		form += "<li class=\"nav-item menu_item\">";
		form += "<a class=\"nav-link\" href=\"http://localhost:6789/mercados\" method=\"get\">Supermercados</a>";
		form += "<li class=\"nav-item menu_item\">";
		form += "<a class=\"nav-link\">|</a>";
		form += "</li>";
		form += "<li class=\"nav-item menu_item\">";
		form += "<a class=\"nav-link\" href=\"http://localhost:6789/login\" method=\"get\">Login</a>";
		form += "</li>";
		form += "</ul>";
        form += "</div>";
        form += "</nav>";
...
/*        List<Estabelecimento> mercados = estabelecimentoDAO.getByProduct(idProduct);
    ...
    public String makeFormEstabelecimento()
    {
        ...
        form += "<form action=\"http://localhost:6789/mercado/adicionar\" method=\"post\">";  
