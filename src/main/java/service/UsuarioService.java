...
public class UsuarioService {
    ...
    public String makeForm(String login, String senha) {
        ...
        form += "<input type=\"password\" name=\"password\" id=\"box\" class=\"form-control\"placeholder=\"Senha\" required>";
        ...
        form += "<input type=\"text\" name=\"cpf\" id=\"user\" class=\"form-control\"placeholder=\"CPF\" required>";
        form += "<label for=\"username\">Usuário</label><br>";
        form += "<input type=\"text\" name=\"login\" id=\"user\" class=\"form-control\"placeholder=\"Usuário\" required>";
        form += "<label for=\"password\">Senha</label><br>";
        form += "<input type=\"password\" name=\"senha\" id=\"senha\" class=\"form-control\"placeholder=\"Senha\" required>";
